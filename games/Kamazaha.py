...
def makeNewBall(velocity, y):
    ball={}
    ball['velocity'] = velocity
    ball['direction'] = 90
    ball['Rect'] = pygame.Rect(20, y, 10, 10)
...
P1['Rect'] = pygame.Rect(20, 250, 20, 50)
P1['Surf'] = pygame.Surface((P1['Rect'].width, P1['Rect'].height))
P1['Surf'].fill(RED)
    ...
    if(gamestate == 1):
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                if (len(Balls) < 2):
                    if event.key == K_d:
                        Balls.append(makeNewBall(20, P1['Rect'].top))
                    #if event.key == K_f:
        ...
        if (P1['moveup'] == True and P1['Rect'].top > 0):
            P1['Rect'].top -= P1Speed
        elif (P1['movedown'] == True and P1['Rect'].top < 580):
            P1['Rect'].top += P1Speed
